...
$validation_link = 'http://localhost/easy-lift/account_validation.php?page=' .$crypt. '';
...
$header = "From: \"*******sujet********\"<******adress mail******".$passage_ligne;
$header.= "Reply-to: \"*************\" <******adress mail******>".$passage_ligne;
